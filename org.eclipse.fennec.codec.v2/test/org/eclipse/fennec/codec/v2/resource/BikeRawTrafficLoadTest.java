...
class BikeRawTrafficLoadTest {
    ...
    void setUp() throws IOException {
        ...
        bikeRawPackage = ecoreHelper.loadEcore(BIKE_RAW_ECORE);
    ...
    class JsonLoadingTests {
        ...
        @Test
        @DisplayName("loads JSON array with CODEC_ROOT_OBJECT hint")
        void loadsJsonArrayWithRootObjectHint() throws IOException {
            CodecResource resource = createResource();

            Map<String, Object> options = new HashMap<>();
            options.put(CodecResource.CODEC_ROOT_OBJECT, historicalRawTrafficClass);

            try (InputStream is = getClass().getResourceAsStream(RAW_TRAFFIC_JSON)) {
