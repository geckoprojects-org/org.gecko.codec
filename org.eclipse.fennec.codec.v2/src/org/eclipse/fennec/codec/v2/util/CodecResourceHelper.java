...
public class CodecResourceHelper {
    ...
    public EClass resolveRootEClass(Map<?, ?> options) {
        ...
        Object rootObject = options.get(CodecResource.CODEC_ROOT_OBJECT);
     ...
     * <p>
     * Used for type collision detection when both CODEC_ROOT_OBJECT and
     * content type information are present.
     * </p>
     *
     * @param hint the expected type (from CODEC_ROOT_OBJECT)
     ...
     * CODEC_ROOT_OBJECT hint and content type information.
     * <p>
     * Resolution rules:
     * <ul>
     ...
     * </p>
     *
     * @param hint the EClass from CODEC_ROOT_OBJECT (may be null)
    ...
    public EClass resolveEffectiveType(EClass hint, EClass contentType) {
        ...
        LOGGER.warning(() -> String.format(
            "Type collision: CODEC_ROOT_OBJECT=%s but content type=%s. Using content type.",
     ...
     * This check is required when resolving CODEC_ROOT_OBJECT to ensure the
