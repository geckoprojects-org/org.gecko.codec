 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.codec.v2.jackson.CodecJsonFactory} - Factory that creates codec-aware parsers</li>
 *   <li>{@link org.eclipse.fennec.codec.v2.jackson.CodecJsonParser} - Parser with EMF context support</li>
 *   <li>{@link org.eclipse.fennec.codec.v2.jackson.CodecJsonReadContext} - JSON read context with EMF state</li>
 * </ul>
 * <p>
 * For non-JSON formats (MongoDB, CSV, etc.), use the generic context classes in
 * {@link org.eclipse.fennec.codec.v2.context} which extend {@link tools.jackson.core.TokenStreamContext}
