 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.DeviceInfoImpl#getTenantId <em>Tenant Id</em>}</li>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.DeviceInfoImpl#getTenantName <em>Tenant Name</em>}</li>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.DeviceInfoImpl#getApplicationId <em>Application Id</em>}</li>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.DeviceInfoImpl#getApplicationName <em>Application Name</em>}</li>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.DeviceInfoImpl#getDeviceProfileId <em>Device Profile Id</em>}</li>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.DeviceInfoImpl#getDeviceProfileName <em>Device Profile Name</em>}</li>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.DeviceInfoImpl#getDeviceName <em>Device Name</em>}</li>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.DeviceInfoImpl#getDevEui <em>Dev Eui</em>}</li>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.DeviceInfoImpl#getDevAddr <em>Dev Addr</em>}</li>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.DeviceInfoImpl#getTags <em>Tags</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeviceInfoImpl extends MinimalEObjectImpl.Container implements DeviceInfo {
	...
	protected EClass eStaticClass() {
		return Lorawan2Package.Literals.DEVICE_INFO;
	}
	...
	public void setTenantId(String newTenantId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.DEVICE_INFO__TENANT_ID, oldTenantId, tenantId));
	}
	...
	public void setTenantName(String newTenantName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.DEVICE_INFO__TENANT_NAME, oldTenantName, tenantName));
	}
	...
	public void setApplicationId(String newApplicationId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.DEVICE_INFO__APPLICATION_ID, oldApplicationId, applicationId));
	}
	...
	public void setApplicationName(String newApplicationName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.DEVICE_INFO__APPLICATION_NAME, oldApplicationName, applicationName));
	}
	...
	public void setDeviceProfileId(String newDeviceProfileId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.DEVICE_INFO__DEVICE_PROFILE_ID, oldDeviceProfileId, deviceProfileId));
	}
	...
	public void setDeviceProfileName(String newDeviceProfileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.DEVICE_INFO__DEVICE_PROFILE_NAME, oldDeviceProfileName, deviceProfileName));
	}
	...
	public void setDeviceName(String newDeviceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.DEVICE_INFO__DEVICE_NAME, oldDeviceName, deviceName));
	}
	...
	public void setDevEui(String newDevEui) {
		...
		devEui = newDevEui;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.DEVICE_INFO__DEV_EUI, oldDevEui, devEui));
	}
	...
	public void setDevAddr(String newDevAddr) {
		...
		devAddr = newDevAddr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.DEVICE_INFO__DEV_ADDR, oldDevAddr, devAddr));
	}
	...
	public NotificationChain basicSetTags(Tags newTags, NotificationChain msgs) {
		...
		tags = newTags;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Lorawan2Package.DEVICE_INFO__TAGS, oldTags, newTags);
	...
	public void setTags(Tags newTags) {
		if (newTags != tags) {
			...
			if (tags != null)
				msgs = ((InternalEObject)tags).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Lorawan2Package.DEVICE_INFO__TAGS, null, msgs);
			if (newTags != null)
				msgs = ((InternalEObject)newTags).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Lorawan2Package.DEVICE_INFO__TAGS, null, msgs);
			msgs = basicSetTags(newTags, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.DEVICE_INFO__TAGS, newTags, newTags));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Lorawan2Package.DEVICE_INFO__TAGS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Lorawan2Package.DEVICE_INFO__TENANT_ID:
				return getTenantId();
			case Lorawan2Package.DEVICE_INFO__TENANT_NAME:
				return getTenantName();
			case Lorawan2Package.DEVICE_INFO__APPLICATION_ID:
				return getApplicationId();
			case Lorawan2Package.DEVICE_INFO__APPLICATION_NAME:
				return getApplicationName();
			case Lorawan2Package.DEVICE_INFO__DEVICE_PROFILE_ID:
				return getDeviceProfileId();
			case Lorawan2Package.DEVICE_INFO__DEVICE_PROFILE_NAME:
				return getDeviceProfileName();
			case Lorawan2Package.DEVICE_INFO__DEVICE_NAME:
				return getDeviceName();
			case Lorawan2Package.DEVICE_INFO__DEV_EUI:
				return getDevEui();
			case Lorawan2Package.DEVICE_INFO__DEV_ADDR:
				return getDevAddr();
			case Lorawan2Package.DEVICE_INFO__TAGS:
				return getTags();
		}
