 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.LoraInfoImpl#getBandwidth <em>Bandwidth</em>}</li>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.LoraInfoImpl#getSpreadingFactor <em>Spreading Factor</em>}</li>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.LoraInfoImpl#getCodeRate <em>Code Rate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LoraInfoImpl extends MinimalEObjectImpl.Container implements LoraInfo {
	...
	protected EClass eStaticClass() {
		return Lorawan2Package.Literals.LORA_INFO;
	}
	...
	public void setBandwidth(int newBandwidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.LORA_INFO__BANDWIDTH, oldBandwidth, bandwidth));
	}
	...
	public void setSpreadingFactor(int newSpreadingFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.LORA_INFO__SPREADING_FACTOR, oldSpreadingFactor, spreadingFactor));
	}
	...
	public void setCodeRate(String newCodeRate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.LORA_INFO__CODE_RATE, oldCodeRate, codeRate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Lorawan2Package.LORA_INFO__BANDWIDTH:
				return getBandwidth();
			case Lorawan2Package.LORA_INFO__SPREADING_FACTOR:
				return getSpreadingFactor();
			case Lorawan2Package.LORA_INFO__CODE_RATE:
				return getCodeRate();
		}
