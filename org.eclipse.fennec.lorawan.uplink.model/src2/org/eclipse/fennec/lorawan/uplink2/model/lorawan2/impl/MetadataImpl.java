 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.MetadataImpl#getRegion_name <em>Region name</em>}</li>
 *   <li>{@link org.eclipse.fennec.lorawan.uplink2.model.lorawan2.impl.MetadataImpl#getRegion_common_name <em>Region common name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetadataImpl extends MinimalEObjectImpl.Container implements Metadata {
	...
	protected EClass eStaticClass() {
		return Lorawan2Package.Literals.METADATA;
	}
	...
	public void setRegion_name(String newRegion_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.METADATA__REGION_NAME, oldRegion_name, region_name));
	}
	...
	public void setRegion_common_name(String newRegion_common_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lorawan2Package.METADATA__REGION_COMMON_NAME, oldRegion_common_name, region_common_name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Lorawan2Package.METADATA__REGION_NAME:
				return getRegion_name();
			case Lorawan2Package.METADATA__REGION_COMMON_NAME:
