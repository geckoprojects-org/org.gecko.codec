 ...
 * 
 */
package org.gecko.codec.test.codectest.foobar.configuration;
...
import org.gecko.codec.test.codectest.foobar.FoobarFactory;
import org.gecko.codec.test.codectest.foobar.FoobarPackage;

import org.gecko.codec.test.codectest.foobar.impl.FoobarPackageImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.codec.test.codectest.foobar.util.FoobarResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource$Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,org.gecko.codec.test.codectest.foobar.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.codec.test.codectest.foobar.FoobarFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,org.gecko.codec.test.codectest.foobar\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.codec.test.codectest.foobar.FoobarPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,org.gecko.codec.test.codectest.foobar\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.gecko.codec.test.codectest.foobar\"" })
