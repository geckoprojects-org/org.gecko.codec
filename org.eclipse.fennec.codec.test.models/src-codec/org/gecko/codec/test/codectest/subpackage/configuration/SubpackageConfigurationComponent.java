 ...
 * 
 */
package org.gecko.codec.test.codectest.subpackage.configuration;
...
import org.gecko.codec.test.codectest.subpackage.SubpackageFactory;
import org.gecko.codec.test.codectest.subpackage.SubpackagePackage;

import org.gecko.codec.test.codectest.subpackage.impl.SubpackagePackageImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.codec.test.codectest.subpackage.util.SubpackageResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource$Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,org.gecko.codec.test.codectest.subpackage.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.codec.test.codectest.subpackage.SubpackageFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,org.gecko.codec.test.codectest.subpackage\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.codec.test.codectest.subpackage.SubpackagePackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,org.gecko.codec.test.codectest.subpackage\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.gecko.codec.test.codectest.subpackage\"" })
