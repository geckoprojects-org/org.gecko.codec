 ...
 * 
 */
package org.gecko.codec.test.codectest.util;
...
import org.gecko.codec.test.codectest.*;
 ...
 * <!-- end-user-doc -->
 * @see org.gecko.codec.test.codectest.CodecTestPackage
 * @generated
 */
public class CodecTestSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CodecTestPackage.CONTACT: {
				Contact contact = (Contact)theEObject;
				T result = caseContact(contact);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CodecTestPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CodecTestPackage.BUSINESS_PERSON: {
