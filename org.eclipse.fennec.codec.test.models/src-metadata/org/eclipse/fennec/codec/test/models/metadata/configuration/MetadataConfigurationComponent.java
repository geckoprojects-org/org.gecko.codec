 ...
 * 
 */
package org.eclipse.fennec.codec.test.models.metadata.configuration;
...
import org.eclipse.fennec.codec.test.models.metadata.MetadataFactory;
import org.eclipse.fennec.codec.test.models.metadata.MetadataPackage;

import org.eclipse.fennec.codec.test.models.metadata.impl.MetadataPackageImpl;

import org.eclipse.fennec.codec.test.models.metadata.util.MetadataResourceFactoryImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.codec.test.models.metadata.util.MetadataResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource$Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,org.eclipse.fennec.codec.test.models.metadata.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.codec.test.models.metadata.MetadataFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.codec.test.models.metadata\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.codec.test.models.metadata.MetadataPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.codec.test.models.metadata\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.codec.test.models.metadata\"" })
