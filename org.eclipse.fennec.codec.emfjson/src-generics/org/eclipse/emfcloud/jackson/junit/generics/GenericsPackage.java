 ...
 */
@ProviderType
@EPackage(uri = GenericsPackage.eNS_URI, genModel = "/../generics.genmodel", genModelSourceLocations = {"test-data/model/generics.genmodel","org.eclipse.fennec.codec.emfjson/test-data/model/generics.genmodel"}, ecore="/../generics.ecore", ecoreSourceLocations="/test-data/model/generics.ecore")
public interface GenericsPackage extends org.eclipse.emf.ecore.EPackage {
	/**
	 * The package name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
