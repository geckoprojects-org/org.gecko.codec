 ...
 */
@ProviderType
@EPackage(uri = PackageAnnotationsPackage.eNS_URI, genModel = "/../packageAnnotations.genmodel", genModelSourceLocations = {"test-data/model/packageAnnotations.genmodel","org.eclipse.fennec.codec.emfjson/test-data/model/packageAnnotations.genmodel"}, ecore="/../packageAnnotations.ecore", ecoreSourceLocations="/test-data/model/packageAnnotations.ecore")
public interface PackageAnnotationsPackage extends org.eclipse.emf.ecore.EPackage {
	/**
	 * The package name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	String eNS_URI = "http://www.emfjson.org/jackson/packageannotations";
