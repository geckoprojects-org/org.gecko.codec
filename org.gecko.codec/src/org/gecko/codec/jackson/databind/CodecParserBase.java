 ...
 * @since Oct 28, 2024
 */
public abstract class CodecParserBase extends ParserMinimalBase {
     ...
     */
    protected CodecReadContext _parsingContext;
    ...
    protected CodecParserBase(IOContext ctxt, int features) {
        ...
        _parsingContext = CodecReadContext.createRootContext(dups);
    }
    ...
    @Override public String getCurrentName() throws IOException {
        ...
        if (_currToken == JsonToken.START_OBJECT || _currToken == JsonToken.START_ARRAY) {
            CodecReadContext parent = _parsingContext.getParent();
            if (parent != null) {
    ...
    @Override public void overrideCurrentName(String name) {
        ...
        CodecReadContext ctxt = _parsingContext;
        if (_currToken == JsonToken.START_OBJECT || _currToken == JsonToken.START_ARRAY) {
            ctxt = ctxt.getParent();
        }
    ...
    @Override public CodecReadContext getParsingContext() { return _parsingContext; }
    ...
    protected void _reportMismatchedEndMarker(int actCh, char expCh) throws JsonParseException {
        CodecReadContext ctxt = getParsingContext();
