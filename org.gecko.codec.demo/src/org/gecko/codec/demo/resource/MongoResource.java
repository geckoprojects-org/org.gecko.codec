...
public final class MongoResource extends CodecResource {

	private MongoDatabaseProvider provider;
	
	public MongoResource(URI uri, CodecModelInfo modelInfo, CodecModule.Builder moduleBuilder, Builder objMapperBuilder) {
		super(uri, modelInfo, moduleBuilder, objMapperBuilder);
	}

	public MongoResource(URI uri, CodecModelInfo modelInfo, CodecModule.Builder moduleBuilder, Builder objMapperBuilder, MongoDatabaseProvider provider) {
		super(uri, modelInfo, moduleBuilder, objMapperBuilder);
