...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Inline Type Mapping</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.codec.metadata.model.codec.impl.InlineTypeMappingImpl#getDiscriminatorValue <em>Discriminator Value</em>}</li>
 *   <li>{@link org.eclipse.fennec.codec.metadata.model.codec.impl.InlineTypeMappingImpl#getTargetClass <em>Target Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InlineTypeMappingImpl extends MinimalEObjectImpl.Container implements InlineTypeMapping {
	/**
	 ...
	 * @generated
	 */
	protected InlineTypeMappingImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CodecPackage.Literals.INLINE_TYPE_MAPPING;
	}
	...
	public void setDiscriminatorValue(String newDiscriminatorValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodecPackage.INLINE_TYPE_MAPPING__DISCRIMINATOR_VALUE, oldDiscriminatorValue, discriminatorValue));
	}
	...
	public void setTargetClass(String newTargetClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodecPackage.INLINE_TYPE_MAPPING__TARGET_CLASS, oldTargetClass, targetClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CodecPackage.INLINE_TYPE_MAPPING__DISCRIMINATOR_VALUE:
				return getDiscriminatorValue();
			case CodecPackage.INLINE_TYPE_MAPPING__TARGET_CLASS:
