 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.models.geojson.impl.CoordinatesImpl#getLongitude <em>Longitude</em>}</li>
 *   <li>{@link org.eclipse.fennec.models.geojson.impl.CoordinatesImpl#getLatitude <em>Latitude</em>}</li>
 *   <li>{@link org.eclipse.fennec.models.geojson.impl.CoordinatesImpl#getElevation <em>Elevation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CoordinatesImpl extends MinimalEObjectImpl.Container implements Coordinates {
	...
	protected EClass eStaticClass() {
		return GeoJsonPackage.Literals.COORDINATES;
	}
	...
	public void setLongitude(double newLongitude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeoJsonPackage.COORDINATES__LONGITUDE, oldLongitude, longitude));
	}
	...
	public void setLatitude(double newLatitude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeoJsonPackage.COORDINATES__LATITUDE, oldLatitude, latitude));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GeoJsonPackage.COORDINATES__LONGITUDE:
				return getLongitude();
