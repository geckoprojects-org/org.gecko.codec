 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.models.geojson.impl.RingImpl#getCoordinates <em>Coordinates</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RingImpl extends MinimalEObjectImpl.Container implements Ring {
	...
	public EList<Coordinates> getCoordinates() {
		if (coordinates == null) {
			coordinates = new EObjectContainmentEList<Coordinates>(Coordinates.class, this, GeoJsonPackage.RING__COORDINATES);
		}
		return coordinates;
	}
