 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.model.openapi.impl.SecuritySchemeEntryImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link org.eclipse.fennec.model.openapi.impl.SecuritySchemeEntryImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecuritySchemeEntryImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String,SecurityScheme> {
	...
	protected EClass eStaticClass() {
		return OpenApiPackage.Literals.SECURITY_SCHEME_ENTRY;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenApiPackage.SECURITY_SCHEME_ENTRY__KEY, oldKey, key));
	}
	...
	public NotificationChain basicSetTypedValue(SecurityScheme newValue, NotificationChain msgs) {
		...
		value = newValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OpenApiPackage.SECURITY_SCHEME_ENTRY__VALUE, oldValue, newValue);
	...
	public void setTypedValue(SecurityScheme newValue) {
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OpenApiPackage.SECURITY_SCHEME_ENTRY__VALUE, null, msgs);
			if (newValue != null)
				msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OpenApiPackage.SECURITY_SCHEME_ENTRY__VALUE, null, msgs);
			msgs = basicSetTypedValue(newValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenApiPackage.SECURITY_SCHEME_ENTRY__VALUE, newValue, newValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OpenApiPackage.SECURITY_SCHEME_ENTRY__VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpenApiPackage.SECURITY_SCHEME_ENTRY__KEY:
				return getTypedKey();
			case OpenApiPackage.SECURITY_SCHEME_ENTRY__VALUE:
