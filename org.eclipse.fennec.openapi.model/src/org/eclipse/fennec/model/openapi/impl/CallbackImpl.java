 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.model.openapi.impl.CallbackImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link org.eclipse.fennec.model.openapi.impl.CallbackImpl#getPaths <em>Paths</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CallbackImpl extends MinimalEObjectImpl.Container implements Callback {
	...
	protected EClass eStaticClass() {
		return OpenApiPackage.Literals.CALLBACK;
	}
	...
	public void setRef(String newRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenApiPackage.CALLBACK__REF, oldRef, ref));
	}
	...
	public EMap<String, PathItem> getPaths() {
		if (paths == null) {
			paths = new EcoreEMap<String,PathItem>(OpenApiPackage.Literals.PATH_ENTRY, PathEntryImpl.class, this, OpenApiPackage.CALLBACK__PATHS);
		}
		return paths;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OpenApiPackage.CALLBACK__PATHS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpenApiPackage.CALLBACK__REF:
				return getRef();
			case OpenApiPackage.CALLBACK__PATHS:
