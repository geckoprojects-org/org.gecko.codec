 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.openapi.model.impl.PutImpl#getRequestBody <em>Request Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PutImpl extends MethodImpl implements Put {
	/**
	...
	protected EClass eStaticClass() {
		return OpenApiPackage.Literals.PUT;
	}
	...
	public NotificationChain basicSetRequestBody(RequestBody newRequestBody, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OpenApiPackage.PUT__REQUEST_BODY, oldRequestBody, newRequestBody);
	...
	public void setRequestBody(RequestBody newRequestBody) {
		if (newRequestBody != requestBody) {
			...
			if (requestBody != null)
				msgs = ((InternalEObject)requestBody).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OpenApiPackage.PUT__REQUEST_BODY, null, msgs);
			if (newRequestBody != null)
				msgs = ((InternalEObject)newRequestBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OpenApiPackage.PUT__REQUEST_BODY, null, msgs);
			msgs = basicSetRequestBody(newRequestBody, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenApiPackage.PUT__REQUEST_BODY, newRequestBody, newRequestBody));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OpenApiPackage.PUT__REQUEST_BODY:
