 ...
 * @since 08.08.2025
 */
public class EcoWittParser extends CodecParserBaseImpl {
	 ...
	 * @param objectCodec 
	 */
	public EcoWittParser(IOContext context, CodecReaderProvider<InputStream> reader) {
	...
	public EcoWittParser(IOContext context, InputStream is) {
	...
	public Version version() {
		return VersionUtil.parseVersion(
				"1.0.0-SNAPSHOT", "org.eclipse.fennec.codec", "codec-ecowitt");
	}
