 ...
 * @generated
 */
public class DraginoAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static DraginoPackage modelPackage;
	 ...
	 * @generated
	 */
	public DraginoAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = DraginoPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected DraginoSwitch<Adapter> modelSwitch =
		new DraginoSwitch<Adapter>() {
			@Override
			public Adapter caseDecodedObject(DecodedObject object) {
				return createDecodedObjectAdapter();
			}
			@Override
			public Adapter caseDraginoLSE01Uplink(DraginoLSE01Uplink object) {
				return createDraginoLSE01UplinkAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.fennec.dragino.message.model.dragino.DecodedObject <em>Decoded Object</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.fennec.dragino.message.model.dragino.DraginoLSE01Uplink <em>LSE01 Uplink</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDraginoLSE01UplinkAdapter() {
		return null;
	}
