...
## 8. ResourceFactory Configuration
...
### 8.1 Constructor-Based Configuration (Recommended)
...
### 8.2 Setter-Based Configuration (DI Frameworks)
...
### 8.3 OSGi Declarative Services Example
...
### 8.4 Spring Configuration Example
...
### 10.3 Internal Context Keys (Read-Only)
...
### 10.6 Type-Safe Configuration (Preferred)
...
### 10.7 Direction-Specific Configuration
