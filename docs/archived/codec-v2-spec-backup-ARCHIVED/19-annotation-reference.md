...
> **Detailed examples:** See [05-type.md §1.1-1.2](05-type.md#11-plain-format-examples) for type format examples, [07-id.md](07-id.md) for ID format examples.
...
> **Detailed examples:** See [type-strategy-scope-proposal.md §8](../codec-v2-spec-working/type-strategy-scope-proposal.md) for comprehensive scope combination examples.
...
> **Detailed documentation:** See [05-type.md](05-type.md) for complete type serialization specification including format/strategy examples, deserialization behavior, and real-world use cases (GeoJSON).
>
> **Working document:** See [type-strategy-scope-proposal.md](../codec-v2-spec-working/type-strategy-scope-proposal.md) for detailed scope behavior, resolution algorithm, and complex multi-level configuration examples.
...
> **Detailed documentation:** See [06-supertype.md](06-supertype.md) for complete supertype serialization specification.
...
> **Detailed documentation:** See [05-type.md §1.3](05-type.md#13-discriminator-mapping-separate-layer) for discriminator mapping specification.
>
> **Working document:** See [type-strategy-scope-proposal.md](../codec-v2-spec-working/type-strategy-scope-proposal.md) for detailed discriminator mapping design.
...
> **Detailed documentation:** See [07-id.md](07-id.md) for complete ID serialization specification.
...
> **Detailed documentation:** See [08-reference.md](08-reference.md) for complete reference serialization specification.
...
> **Detailed documentation:** See [09-feature.md](09-feature.md) for complete feature serialization specification including null/default handling, enum serialization, and array attributes.
