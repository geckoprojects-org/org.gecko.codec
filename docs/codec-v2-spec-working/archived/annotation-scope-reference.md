...
[← Back to Overview](../codec-v2-spec/00-overview.md)
...
|---------------|--------------|-------------|
| `CODEC_ROOT_TYPE` | `"codec.rootType"` | Type hint for root object (was `CODEC_ROOT_OBJECT`) |
...
| `CODEC_FEATURE_VALUE_READERS` | `"codec.featureValueReaders"` | Per-feature value readers |
| `CODEC_FEATURE_VALUE_WRITERS` | `"codec.featureValueWriters"` | Per-feature value writers |
...
> **Detailed examples:** See [05-type.md §1.1-1.2](../codec-v2-spec/05-type.md#11-plain-format-examples) for type format examples, [07-id.md](../codec-v2-spec/07-id.md) for ID format examples.
...
> **Detailed examples:** See [type-strategy-scope-proposal.md §8](type-strategy-scope-proposal.md) for comprehensive scope combination examples.

**Note:** StrategyScope is **runtime-only** (🔧) - no EAnnotation equivalent. See [EPackage Scope Proposal](epackage-scope-proposal.md) for discussion on why.
...
> **Note:** EPackage-level annotations are under consideration as a future scope level. This would allow package-wide defaults and is especially relevant for cross-package references. See [EPackage Scope Proposal](epackage-scope-proposal.md) for details and edge cases.
...
> **Detailed documentation:** See [05-type.md](../codec-v2-spec/05-type.md) for complete type serialization specification including format/strategy examples, deserialization behavior, and real-world use cases (GeoJSON).
>
> **Working document:** See [type-strategy-scope-proposal.md](type-strategy-scope-proposal.md) for detailed scope behavior, resolution algorithm, and complex multi-level configuration examples.
...
> **Why `typeScope`/`typeFormatScope` are runtime-only:** These properties control *where* a strategy applies (ROOT_ONLY, ROOT_CONTAINMENT, etc.), which is a runtime/operational concern rather than a model-intrinsic property. Additionally, their semantics become unclear with cross-package references. See [EPackage Scope Proposal](epackage-scope-proposal.md) for discussion.
...
> **Detailed documentation:** See [06-supertype.md](../codec-v2-spec/06-supertype.md) for complete supertype serialization specification.
...
> **Detailed documentation:** See [05-type.md §1.3](../codec-v2-spec/05-type.md#13-discriminator-mapping-separate-layer) for discriminator mapping specification.
>
> **Working document:** See [type-strategy-scope-proposal.md](type-strategy-scope-proposal.md) for detailed discriminator mapping design.
...
> **Detailed documentation:** See [07-id.md](../codec-v2-spec/07-id.md) for complete ID serialization specification.
...
> **Detailed documentation:** See [08-reference.md](../codec-v2-spec/08-reference.md) for complete reference serialization specification.
...
**Implementation:** `CodecAnnotationConstants.KEY_REF_*`, `CodecAnnotationConstants.KEY_EXPAND`
...
> **Detailed documentation:** See [09-feature.md](../codec-v2-spec/09-feature.md) for complete feature serialization specification including null/default handling, enum serialization, and array attributes.
...
- [ ] **EPackage Scope Level**: See [epackage-scope-proposal.md](epackage-scope-proposal.md)

- [ ] **EMF Configuration Model**: See [emf-configuration-model-proposal.md](emf-configuration-model-proposal.md)

- [ ] Update spec `09-feature.md` to align with new `ignore*` / `force*` naming
...
| 2026-01-23 | Added note about EPackage scope level proposal with link to [epackage-scope-proposal.md](epackage-scope-proposal.md) |
