 ...
 * @generated
 */
public class TestTypeAnnotationInheritanceSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public TestTypeAnnotationInheritanceSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TestTypeAnnotationInheritancePackage.MEETING: {
...
} //TestTypeAnnotationInheritanceSwitch
