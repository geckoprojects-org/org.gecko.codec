 ...
 * </p>
 * <ul>
 *   <li>{@link org.gecko.codec.demo.model.person.impl.ParentImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParentImpl extends MinimalEObjectImpl.Container implements Parent {
	...
	protected EClass eStaticClass() {
		return PersonPackage.Literals.PARENT;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PersonPackage.PARENT__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PersonPackage.PARENT__TYPE:
				return getType();
		}
